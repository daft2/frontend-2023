...
const ActionCircle: React.FC<ActionCircleType> = ({
  ...
  return (
    <div
      {...props}
      className={`${className} ${colorMap[action].background} ${colorMap[action].border} w-fit rounded-[100%] p-3 lg:p-4 flex items-center justify-center shadow-xl border-b-[6px]`}
    >
